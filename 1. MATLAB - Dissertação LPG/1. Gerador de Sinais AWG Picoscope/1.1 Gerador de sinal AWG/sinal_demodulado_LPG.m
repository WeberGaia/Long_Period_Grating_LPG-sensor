...
hold on
%% 1540nm
[banda1540,lbds,Lr] = generator_CSV_lbds(1540);
plot(lbds,banda1540)
hold on
%% 1539nm
...
xlim([1510 1580])
%% 1535nm
[banda,lbds,Lr] = generator_CSV_lbds(1535);
plot(lbds,banda)
hold on
xlim([1510 1580])
%% 1534nm
[banda,lbds,Lr] = generator_CSV_lbds(1534);
plot(lbds,banda)
hold on
xlim([1510 1580])
%% 1533nm
[banda,lbds,Lr] = generator_CSV_lbds(1533);
plot(lbds,banda)
hold on
xlim([1510 1580])
%% 1532nm
[banda,lbds,Lr] = generator_CSV_lbds(1532);
plot(lbds,banda)
hold on
xlim([1510 1580])
%% 1531nm
[banda,lbds,Lr] = generator_CSV_lbds(1531);
plot(lbds,banda)
hold on
xlim([1510 1580])
%% 1530nm
[banda,lbds,Lr] = generator_CSV_lbds(1530);
plot(lbds,banda)
hold on
xlim([1510 1580])
%% 
