...
elseif length(norm) == L && Lr == 1535
    writematrix(norm','C:\Users\weber\Desktop\Dissertação - Simulador e  Interrogador LPG\3. Arquivos MATLAB\6. Sinal demodulado LPG (teoria)\2. CSV\1535nm.csv')
    X = ['Gravação concluída para ',num2str(Lr),'nm'];
    disp(X)
elseif length(norm) == L && Lr == 1534
    writematrix(norm','C:\Users\weber\Desktop\Dissertação - Simulador e  Interrogador LPG\3. Arquivos MATLAB\6. Sinal demodulado LPG (teoria)\2. CSV\1534nm.csv')
    X = ['Gravação concluída para ',num2str(Lr),'nm'];
    disp(X)
elseif length(norm) == L && Lr == 1533
    writematrix(norm','C:\Users\weber\Desktop\Dissertação - Simulador e  Interrogador LPG\3. Arquivos MATLAB\6. Sinal demodulado LPG (teoria)\2. CSV\1533nm.csv')
    X = ['Gravação concluída para ',num2str(Lr),'nm'];
    disp(X)
elseif length(norm) == L && Lr == 1532
    writematrix(norm','C:\Users\weber\Desktop\Dissertação - Simulador e  Interrogador LPG\3. Arquivos MATLAB\6. Sinal demodulado LPG (teoria)\2. CSV\1532nm.csv')
    X = ['Gravação concluída para ',num2str(Lr),'nm'];
    disp(X)
elseif length(norm) == L && Lr == 1531
    writematrix(norm','C:\Users\weber\Desktop\Dissertação - Simulador e  Interrogador LPG\3. Arquivos MATLAB\6. Sinal demodulado LPG (teoria)\2. CSV\1531nm.csv')
    X = ['Gravação concluída para ',num2str(Lr),'nm'];
    disp(X)
elseif length(norm) == L && Lr == 1530
    writematrix(norm','C:\Users\weber\Desktop\Dissertação - Simulador e  Interrogador LPG\3. Arquivos MATLAB\6. Sinal demodulado LPG (teoria)\2. CSV\1530nm.csv')
    X = ['Gravação concluída para ',num2str(Lr),'nm'];
    disp(X)
