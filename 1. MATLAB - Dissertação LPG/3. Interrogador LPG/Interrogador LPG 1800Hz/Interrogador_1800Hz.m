...
%% 
% H1 = abs(P1(indice_H1+1));                                                  % Ciclo 180                                          
% H2 = abs(P1(indice_H2+1));                                                  % Ciclo 180
% H1 = abs(P1(indice_H1));                                                  % Ciclo 90                                          
% H2 = abs(P1(indice_H2));                                                  % Ciclo 90
H1 = abs(P1(indice_H1+2));                                                  % Ciclo 60                                          
H2 = abs(P1(indice_H2+2));                                                  % Ciclo 60
% H1 = abs(P1(indice_H1));                                                  % 11999                                                
% H2 = abs(P1(indice_H2));                                                  % 11999 ciclo 90
H = H1/H2;                                                                  
