...
fase = rad2deg(fase1(indice_H2+1));                                           % Fase do segundo harmônico
...
tit = ['Interrogador LPG para ',num2str(Lr2(1)),'nm c/ distorção de ',num2str(d),'%'];
...
thd(DAQ,Fs,2);
%% 
% save('C:\Users\weber\Desktop\Resultados Experimentais\Distorção 0%\1540nm\DAQ_7200sps','DAQ')
%% OBSERVAÇÕES
% Arquivo para 30 ciclos