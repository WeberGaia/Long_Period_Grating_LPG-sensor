...
lambda = 1530
d = 1;
[freq,P1,Lr1,H1,H2,indice_H1,indice_H2] = Interrogador_1800Hz_ruido(lambda,d);
fh1 = figure(1);
...
%% DISTORÇÃO 2%
d = 2;
[freq,P1,Lr2,H1,H2,indice_H1,indice_H2] = Interrogador_1800Hz_ruido(lambda,d);
subplot(2,2,2)
plot(freq,10*log10(P1))                                                     % Plotagem gráfica
xlim([xmin xmax])                                                           % Limitação do eixo X
ylim([ymin ymax])                                                           % Limitação do eixo Y
...
%% DISTORÇÃO 3%
d = 3;
[freq,P1,Lr3,H1,H2,indice_H1,indice_H2] = Interrogador_1800Hz_ruido(lambda,d);
subplot(2,2,3)
plot(freq,10*log10(P1))                                                     % Plotagem gráfica
xlim([xmin xmax])                                                           % Limitação do eixo X
ylim([ymin ymax])                                                           % Limitação do eixo Y
...
%% DISTORÇÃO 3.35%
d = 3.35;
[freq,P1,Lr4,H1,H2,indice_H1,indice_H2] = Interrogador_1800Hz_ruido(lambda,d);
subplot(2,2,4)
plot(freq,10*log10(P1))                                                     % Plotagem gráfica
xlim([xmin xmax])                                                           % Limitação do eixo X
ylim([ymin ymax])                                                           % Limitação do eixo Y
